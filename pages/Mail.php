...
{
$to       = 'jai.codoid@gmail.com';
$subject  = 'Divya Enterprises-Contact';
$subject1  = 'Divya Enterprises';
$message  = "$name Contacted Us. <br><br>Here is some information about $name.<br><br>
Name: $name<br>
E-mail: $email<br>
...
if(mail($email, $subject1, $message1, $headers) &&  mail($to, $subject, $message, $headers))
{

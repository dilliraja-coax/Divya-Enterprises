...
<link type="text/css" rel="stylesheet" href="../css/mfp.css" />
		...
		<div class="top-nav">
			<span class="menu"><img src="../images/menu.png" alt=""> </span>
				<ul>
					...
					<li  class="active"><a href="web/Gallery">Gallery</a></li>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item active">
        <img src="../images/banner/b1.jpg" alt="Chania">
        
      </div>

      <div class="item">
        <img src="../images/banner/b2.jpg" alt="Chania">
        
      </div>
    
      <div class="item">
        <img src="../images/banner/b3.jpg" alt="Flower">
        
      </div>

      <div class="item">
        <img src="../images/banner/b4.jpg" alt="Flower">

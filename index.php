		...
		<div class="top-nav">
			<span class="menu"><img src="images/menu.png" alt=""> </span>
				<ul>
					...
					<li><a href="pages/Our_Products.php" class="hvr-sweep-to-bottom">Our Products</a></li>
					<li><a href="pages/About_us.php" class="hvr-sweep-to-bottom ">About Us</a></li>
					<li><a href="pages/Gallery.php" class="hvr-sweep-to-bottom ">Gallery</a></li>

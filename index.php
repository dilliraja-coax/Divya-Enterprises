		...
		<div class="top-nav">
			<span class="menu"><img src="images/menu.png" alt=""> </span>
				<ul>
					...
					<li><a href="pages/Our_Products" class="hvr-sweep-to-bottom">Our Products</a></li>
					<li><a href="pages/About_us" class="hvr-sweep-to-bottom ">About Us</a></li>
					<li><a href="pages/Gallery" class="hvr-sweep-to-bottom ">Gallery</a></li>
					<li><a href="pages/Contact" class="hvr-sweep-to-bottom">Contact Us</a></li>
				</ul>
